...
export const analyticsConfig = {
    ...
    enabled: process.env.NODE_ENV === 'production' && process.env.NEXT_PUBLIC_DISABLE_ALL_ANALYTICS !== 'true',

    // Force enable analytics in development (for testing)
    forceEnable: process.env.NEXT_PUBLIC_ANALYTICS_DEBUG === 'true' && process.env.NEXT_PUBLIC_DISABLE_ALL_ANALYTICS !== 'true',
    ...
    plausible: {
        ...
        enabled: process.env.NEXT_PUBLIC_PLAUSIBLE_DOMAIN !== undefined && typeof window !== 'undefined',
    ...
    features: {
        formTracking: process.env.NEXT_PUBLIC_DISABLE_FORM_TRACKING !== 'true' && process.env.NEXT_PUBLIC_ANALYTICS_SAFE_MODE !== 'true',
        scrollTracking: process.env.NEXT_PUBLIC_DISABLE_SCROLL_TRACKING !== 'true' && process.env.NEXT_PUBLIC_ANALYTICS_SAFE_MODE !== 'true',
        ctaTracking: process.env.NEXT_PUBLIC_DISABLE_CTA_TRACKING !== 'true' && process.env.NEXT_PUBLIC_ANALYTICS_SAFE_MODE !== 'true',
        errorTracking: true, // Always enabled for debugging
        performanceTracking: process.env.NODE_ENV === 'production' && process.env.NEXT_PUBLIC_ANALYTICS_SAFE_MODE !== 'true',
    },
