 ...
 */
export function trackPlausibleEvent(eventName: string, data?: PlausibleEventData): void {
 ...
 */
export function trackPlausiblePageView(path?: string, props?: Record<string, string | number | boolean>): void {
  if (!isPlausibleAvailable()) {
 ...
 */
export function trackPlausibleGoal(goalName: string, data?: PlausibleEventData): void {
 ...
 */
export function trackPlausibleDownload(fileName: string, fileUrl: string): void {
 ...
 */
export function trackPlausibleFormSubmission(formName: string, success: boolean = true): void {
 ...
 */
export function trackPlausibleCTAClick(ctaText: string, position: string, page?: string): void {
 ...
 */
export function trackPlausibleEngagement(eventType: string, data?: Record<string, string | number | boolean>): void {
 ...
 */
export function trackPlausibleScrollDepth(percentage: number, page?: string): void {
 ...
 * Track error events
 */
export function trackPlausibleError(errorType: string, errorMessage: string, page?: string): void {
