...
export const metadata: Metadata = {
  ...
  description:
    'Our comprehensive privacy policy detailing how Silent Scribe protects your data through local processing and transparent practices.',
}
        ...
        <div className="prose prose-lg prose-slate max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-text-secondary mb-4">
              At Silent Scribe, privacy isn't an afterthought—it's the
              foundation of everything we build. We believe that your code,
              documentation, and writing should never leave your machine unless
              you explicitly choose to share it.
            </p>
            <p className="text-text-secondary mb-4">
              This Privacy Policy explains how Silent Scribe ("we," "us," or
              "our"), owned and managed by Sequenxa, collects, uses, and
              protects your information when you use our website and writing
              assistant software. Silent Scribe operates as an independent
              product under Sequenxa's privacy-first technology umbrella.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-6">
              <p className="text-blue-800 font-medium">
                <strong>Key Principle:</strong> Silent Scribe's core writing
                assistant software processes all your text locally on your
                device. Your documents, code, and writing content never leave
                your machine.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-text-secondary mb-4">
              We use privacy-focused analytics to understand how our website is
              used:
            </p>
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              <li>
                Page views and navigation patterns (without tracking
                individuals)
              </li>
              ...
              <li>
                No cookies, no cross-site tracking, no personal identifiers
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              ...
              <li>
                GitHub username (optional, helps us understand your development
                context)
              </li>
              <li>
                Current writing tools and workflows (to improve our product)
              </li>
              <li>
                Team size and use case description (for better beta experience)
              </li>
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              ...
              <li>
                Email engagement (opened, clicked) - anonymous aggregated data
                only
              </li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-4 my-6">
              ...
              <p className="text-green-800">
                Silent Scribe's writing assistant runs entirely on your local
                machine. Your text, code, documentation, and any content you're
                writing or editing is processed locally and never transmitted to
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              <li>
                <strong>Local Analysis Engine:</strong> All grammar, style, and
                writing checks happen on your device
              </li>
              <li>
                <strong>Offline Operation:</strong> The assistant works without
                an internet connection
              </li>
              <li>
                <strong>No Cloud Dependencies:</strong> No text processing
                happens on remote servers
              </li>
              <li>
                <strong>Private by Design:</strong> Your writing remains private
                to you and your chosen collaborators
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              ...
              <li>
                Any proprietary or confidential information in your documents
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-text-secondary text-sm mt-1">
                  Stores beta signup information and email preferences. EU-based
                  servers with GDPR compliance.
                </p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4">
                <h4 className="font-medium text-text-primary">
                ...
                <p className="text-text-secondary text-sm mt-1">
                  Sends beta program emails and updates. Industry-standard
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-text-secondary text-sm mt-1">
                  Privacy-focused website analytics. No cookies, no personal
                  data tracking, GDPR compliant.
                </p>
              </div>
            </div>
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              <li>
                Your documents or writing content (it never leaves your device)
              </li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              <li>
                <strong>Data Access:</strong> Request a copy of all data we have
                about you
              </li>
              <li>
                <strong>Data Correction:</strong> Update or correct any
                inaccurate information
              </li>
              <li>
                <strong>Data Deletion:</strong> Request complete removal of your
                data from our systems
              </li>
              <li>
                <strong>Email Preferences:</strong> Unsubscribe or modify your
                communication preferences at any time
              </li>
              <li>
                <strong>Account Deletion:</strong> Delete your beta account and
                all associated data
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
              ...
              <li>
                No retention of data after opt-out (except as legally required)
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-text-secondary mb-4">
              ...
              practices or legal requirements. When we do:
            </p>
            <ul className="list-disc list-inside text-text-secondary mb-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-text-secondary mb-4">
              We're committed to transparency and responsiveness regarding your
              privacy concerns. If you have questions about this Privacy Policy
            ...
            <p className="text-text-secondary mt-6">
              For urgent security concerns or data breach reports, please use
              our priority contact:
          ...
          <section className="mb-12">
            ...
            <p className="text-text-secondary mb-4">
              This Privacy Policy is designed to comply with major privacy
            ...
            <p className="text-text-secondary">
              Our commitment to privacy goes beyond legal compliance—it's a core
              value that guides every product and business decision we make.
            </p>
          </section>
        </div>
      </div>
