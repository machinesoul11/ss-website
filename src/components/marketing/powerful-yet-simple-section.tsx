...
const powerFeatures = [
  {
    ...
    description: 'All the sophisticated rule checking and customization capabilities you need',
    icon: BoltIcon,
    details: [
  ...
  },
  {
    ...
    description: 'Zero configuration required - works immediately out of the box',
    icon: SparklesIcon,
    details: [
    ...
    <section id="powerful-simple" className="py-24 sm:py-32 bg-document-gray">
      <Container>
        ...
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-quill-blue">Powerful Yet Simple</h2>
          ...
          <p className="mt-6 text-lg leading-8 text-text-gray">
            Vale gives you power but punishes you with complexity. Grammarly gives you simplicity but 
            lacks the features technical teams need. Silent Scribe delivers both.
          </p>
        </div>
              ...
              <div key={feature.title} className="relative">
                <div className="bg-parchment-white rounded-2xl p-8 shadow-sm ring-1 ring-border-gray h-full">
                  <div className="flex items-center mb-6">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-ink-black">{feature.title}</h3>
                    </div>
                  </div>
                  <p className="text-text-gray mb-6">{feature.description}</p>
                  <ul className="space-y-2">
                    {feature.details.map((detail) => (
                      <li key={detail} className="flex items-center text-sm text-text-gray">
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          <div className="text-center mb-8">
            <h3 className="text-xl font-semibold text-ink-black">The Silent Scribe Difference</h3>
            <p className="mt-2 text-text-gray">See how we've solved the complexity problem</p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {simplificationBenefits.map((benefit) => (
              <div key={benefit.title} className="bg-parchment-white rounded-lg p-6 border border-border-gray">
                <div className="flex items-center mb-4">
                  <benefit.icon className="h-5 w-5 text-quill-blue mr-3 flex-shrink-0" />
                  <h4 className="font-medium text-ink-black">{benefit.title}</h4>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-red-50 border border-red-200 rounded p-3">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-xs font-medium text-error-crimson">Before</span>
                    </div>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded p-3">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-xs font-medium text-suggestion-green">After</span>
                    </div>
