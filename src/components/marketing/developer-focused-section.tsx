...
export function DeveloperFocusedSection() {
  return (
    <section
      id="developers"
      className="py-24 sm:py-32 bg-gradient-to-b from-parchment-white to-document-gray"
    >
      <Container>
        {/* Main heading */}
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-text-gray">
            Designed by developers who were frustrated with existing solutions.
            We understand your workflow, your privacy concerns, and your need
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {developerFeatures.map((feature) => (
              <div
                key={feature.name}
                className="bg-parchment-white rounded-lg p-6 hover:shadow-lg transition-shadow border border-border-gray hover:border-quill-blue/20 hover:bg-document-gray/30"
              >
                <div className="flex items-start mb-4">
                  <div
                    className={`flex h-8 w-8 items-center justify-center rounded-md ${feature.iconBg} flex-shrink-0 mt-1`}
                  >
                    <feature.icon
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="text-xs text-quill-blue font-medium mt-1">
                      {feature.stat}
                    </p>
                  </div>
                </div>
                <p className="text-sm leading-relaxed text-text-gray mt-3">
                  {feature.description}
                </p>
              </div>
            ))}
            ...
            <Grid cols={2} gap="md" className="max-w-3xl mx-auto">
              {credibilityIndicators.map((indicator) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-medium text-ink-black text-sm">
                      {indicator.metric}
                    </h4>
        ...
        <div className="mx-auto mt-16 max-w-2xl text-center">
          <div className="bg-parchment-white border border-border-gray rounded-lg p-6">
            ...
            <p className="text-sm text-text-gray mb-4">
              Built by developers with experience at enterprise companies who
              understand the real challenges of technical documentation and
