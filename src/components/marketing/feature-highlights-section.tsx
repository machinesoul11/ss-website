...
const featureHighlights = [
  {
    name: 'Privacy First',
    description: 'Complete local processing. Zero data transmission to external servers.',
    icon: ShieldCheckIcon,
    category: 'Privacy'
  },
  {
    name: 'Lightning Fast',
    description: 'Real-time suggestions as you type. No lag, no delays, no waiting.',
    icon: BoltIcon,
    category: 'Performance'
  },
  {
    name: 'Code Context Aware',
    description: 'Understands code blocks, API references, and technical terminology.',
    icon: CodeBracketIcon,
    category: 'Intelligence'
  },
  {
    name: 'Zero Configuration',
    description: 'Works immediately after install. Intelligent defaults for technical writing.',
    icon: CogIcon,
    category: 'Simplicity'
  },
  {
    name: 'Style Guide Enforcement',
    description: 'Built-in rules from Google, Microsoft, and other tech industry leaders.',
    icon: DocumentTextIcon,
    category: 'Quality'
  },
  {
    name: 'Instant Setup',
    description: 'Browser extension installs in seconds. Start writing immediately.',
    icon: ClockIcon,
    category: 'Efficiency'
  },
  {
    name: 'Works Everywhere',
    description: 'GitHub, GitLab, Notion, Google Docs, and any web-based editor.',
    icon: GlobeAltIcon,
    category: 'Compatibility'
  },
  {
    name: 'Extensible Rules',
    description: 'Add custom rules and style preferences without complex configuration.',
    icon: PuzzlePieceIcon,
    category: 'Customization'
  },
  {
    name: 'Team Collaboration',
    description: 'Share style configurations across your team for consistent documentation.',
    icon: UserGroupIcon,
    category: 'Collaboration'
  },
  {
    name: 'Multiple Formats',
    description: 'Supports Markdown, reStructuredText, AsciiDoc, and plain text.',
    icon: AcademicCapIcon,
    category: 'Versatility'
  },
  {
    name: 'Enterprise Ready',
    description: 'GDPR compliant, SOC 2 ready, perfect for regulated industries.',
    icon: CheckBadgeIcon,
    category: 'Compliance'
  },
  {
    name: 'AI-Powered',
    description: 'Advanced language models running locally for intelligent suggestions.',
    icon: SparklesIcon,
    category: 'Intelligence'
  }
]
...
export function FeatureHighlightsSection() {
  return (
    <section id="features" className="py-24 sm:py-32 bg-gradient-to-b from-parchment-white via-document-gray to-parchment-white">
      <Container>
        {/* Section header */}
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-quill-blue">Feature Highlights</h2>
          ...
          <p className="mt-6 text-lg leading-8 text-text-gray">
            Comprehensive writing assistance built specifically for developers and technical teams. 
            No compromises on features, privacy, or user experience.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featureHighlights.map((feature) => (
              ...
              >
                {/* Category badge */}
                <div className="mb-4">
                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${categoryColors[feature.category as keyof typeof categoryColors] || categoryColors.Quality}`}>
                    {feature.category}
                  </span>
                </div>
          ...
          <div className="bg-gradient-to-r from-document-gray to-parchment-white rounded-2xl p-8 border border-border-gray">
            ...
            <Grid cols={4} gap="lg" className="max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-xs text-text-gray mt-1">Local Processing</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-quill-blue">&lt;30s</div>
                <div className="text-xs text-text-gray mt-1">Setup Time</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-quill-blue">0</div>
                <div className="text-xs text-text-gray mt-1">Data Transmitted</div>
              </div>
            </Grid>
          </div>
        </div>
