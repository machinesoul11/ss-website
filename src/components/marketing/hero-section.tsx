...
import { EnhancedButton, ScrollDepthTracker, ConversionFunnelStep } from '@/components/analytics'
          ...
          <Container>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-text-gray">
                Get Vale-level power with Grammarly-level simplicity. All processing happens locally—your code, 
                docs, and ideas never leave your machine. Finally, a writing tool built by developers, for developers.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Link href="#privacy" className="text-ui-label font-medium text-text-gray hover:text-quill-blue transition-colors">
                  Learn about our privacy approach <span aria-hidden="true">→</span>
                </Link>
              </div>
